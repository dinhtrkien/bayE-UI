        ...
        <div>
          <div className="container mx-auto px-4 py-2 md:py-10">
            <div className="">
              ...
              <div className="relative rounded-lg border-gray-600 border">
                          ...
                          {dayCount.map((d, i) => (
                            ...
                            >
                              <div
                                ...
                                className={`mt-2 cursor-pointer text-center text-sm leading-none rounded-full leading-loose transition ease-in-out duration-100 ${
                                  isToday(d)
